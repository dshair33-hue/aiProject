(function(){
  ...
  async function init(){
    ...
    // Enemies will be auto-placed when combat starts
  ...
  function onStartCombat(){
    ...
    // Auto-place enemies from Stage.csv (x,y from columns 3,4)
  ...
  function onRestart(){
    ...
    // Clear enemies; they will be auto-placed on next battle start
    clearEnemies();
